...
function Add() {
  ...
  let uniqueId=ids.slice(0,8); //to cut from the unique id to 8 digit
  console.log(uniqueId);

  Employee.push({ //add data to the Employee array
    id:uniqueId,
    empname:empname,
    age:age,
        ...
        <Col xs={12} md={6} className="px-0 mr-3" >
          <Form className="border border-4 p-5">
            ...
            <Form.Label>Salary</Form.Label>
              <Form.Control type="text" placeholder="Enter the salary" 
              // value={salary} 
